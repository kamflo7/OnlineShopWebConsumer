...
@Component({
  selector: 'app-admin-navigation-edit',
  templateUrl: './admin-navigation-edit.component.html',
  styleUrls: ['./admin-navigation-edit.component.css']
})
export class AdminNavigationEditComponent implements OnInit {
